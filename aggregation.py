...
def combine_patches_multiple_images(values, 
    ...
    distances=None,I=None,I_bp1=None,distances_bp111=None):
    # import ipdb; ipdb.set_trace()
    if I_bp1 is not None:
        assert I is None
        I = I_bp1
    if distances_bp111 is not None:
        assert distances is None
        distances = distances_bp111
    # if I_bP1 is not None:
    #     assert I is None
    #     I = I_bP1
    ...
    # import ipdb; ipdb.set_trace()
    I1 = I.reshape(distances.shape[0],I.shape[0]//distances.shape[0])
    for ii,(v) in enumerate(values):            
        ...
        if distances is not None:
            d = distances[ii]
        I1 = I[ii]
        # v = dutils.permuted_patches1[0]
        result = combine_patches(v, (patch_size,patch_size), stride, img_shape,as_np=as_np,
