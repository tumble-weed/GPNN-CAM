...
def main(config=None):
    ...
    for i in range(n_super_iters):
        ...
        saliency_dict = get_saliency(augmentations,aggregation_results,(config_i['patch_size'],config_i['patch_size']),imagenet_target,saliency_method='gradcam')        
        if i > 0:
...
if __name__ == '__main__':    
    if True:
        ...
        config = {
        'out_dir':'gpnn-gradcam-perturb/output',
        'iters':10,
        # 'iters':1,#10
        'coarse_dim':14,#
        # 'coarse_dim':28,
